...
namespace CurceRPVS
{
    public partial class Form1 : Form
    {
        ...
        {
            Setting form;
            if (this.Name == "SettingGrafMenu")
                form = new Setting(settings, 1);
            else
                form = new Setting(settings, 2);
            form.ShowDialog();
        ...
        private void SetSetting()
        {
            ...
            this.BackColor = settings.colorFrom;
        }
        ...
        private void ExcelMenu_Click(object sender, EventArgs e)
        {
            new Excels().SaveExcel(dataGridView1);
        }
        ...
        private void ClearTableMenu_Click(object sender, EventArgs e)
        {
            dataGridView1.Rows.Clear();
            dataGridView1.Columns.Clear();
        }
